...
void GeometryEngine::initCubeGeometry()
{
    ...
    VertexData vertices[] = {
        ...
        */
        ...
        {QVector3D( 1.0f, -1.0f,  1.0f), QVector3D( 1.0f, 0.0f, 1.0f)}, // v4
        {QVector3D( 1.0f, -1.0f, -1.0f), QVector3D(1.0f, 0.0f, 0.0f)}, // v5
        {QVector3D( 1.0f,  1.0f,  1.0f), QVector3D(1.0f, 1.0f, 1.0f)},  // v6
        {QVector3D( 1.0f,  1.0f, -1.0f), QVector3D(1.0f, 1.0f, 0.0f)}, // v7

        // // Vertex data for face 2
        {QVector3D( 1.0f, -1.0f, -1.0f), QVector3D(1.0f, 0.0f, 0.0f)}, // v8
        {QVector3D(-1.0f, -1.0f, -1.0f), QVector3D(0.0f, 0.0f, 0.0f)},  // v9
        {QVector3D( 1.0f,  1.0f, -1.0f), QVector3D(1.0f, 1.0f, 0.0f)}, // v10
        {QVector3D(-1.0f,  1.0f, -1.0f), QVector3D(0.0f, 1.0f, 0.0f)},  // v11

        // // Vertex data for face 3
        {QVector3D(-1.0f, -1.0f, -1.0f), QVector3D(0.0f, 0.0f, 0.0f)}, // v12
        {QVector3D(-1.0f, -1.0f,  1.0f), QVector3D(0.0f, 0.0f, 1.0f)},  // v13
        {QVector3D(-1.0f,  1.0f, -1.0f), QVector3D(0.0f, 1.0f, 0.0f)}, // v14
        {QVector3D(-1.0f,  1.0f,  1.0f), QVector3D(0.0f, 1.0f, 1.0f)},  // v15

        // // Vertex data for face 4
        {QVector3D(-1.0f, -1.0f, -1.0f), QVector3D(0.0f, 0.0f, 0.0f)}, // v16
        ...
        {QVector3D( 1.0f,  1.0f,  1.0f), QVector3D(1.0f, 1.0f, 1.0f)}, // v21
        {QVector3D(-1.0f,  1.0f, -1.0f), QVector3D(0.0f, 1.0f, 0.0f)}, // v22
        {QVector3D( 1.0f,  1.0f, -1.0f), QVector3D(1.0f, 1.0f, 0.0f)}  // v23
    };
...
void GeometryEngine::initWireCubeGeometry()
{
    ...
    //MAYBE CREATE NEW VERTEXDATA OBJECT, USED FOR WIRE CUBE
    /*VertexData vertices[] = {
        // Vertex data for face 0
        {QVector3D(1.0f, -1.0f,  1.0f), QVector2D(0.0f, 0.0f)},  // v0
        {QVector3D( 1.0f, 1.0f,  1.0f), QVector2D(0.33f, 0.0f)}, // v1
